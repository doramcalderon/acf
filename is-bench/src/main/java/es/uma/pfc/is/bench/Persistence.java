...
public class Persistence {
    ...
    protected void persist(Object entity, String outputPath, boolean createIfNoExists) throws JAXBException {
    ...
    protected File getOuputFile(String outputPath, boolean createIfNoExists) {
        File outputFile;
        if (createIfNoExists) {
            try {
