...
Sabemos qul \ %includegraphics[width=63pt]{img-232.eps}
(conjunto de todos ers conceptos foomales) con %\ %includegraphics[width=15pt]{img-233.eps}
...
\ %includegraphics[width=12pt]{img-236.eps}
...
\end{enumerate}
\begin{enumerate}
	\item %\includegraphics[width=34pt]{img-283.eps}
         es
...
\begin{enumerate}
	\item %includegraphics[width=353pt]{img-731.eps}
		\textbf{Tiempos}
\end{enumerate}
