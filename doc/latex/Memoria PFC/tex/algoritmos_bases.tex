...
\chapter{ALGORITMOS DE CÁLCULO DE BASES}
	\newpage
	...
	algoritmos se incluyan en dicha librería.
...
%			
%				A continuación se enumeran los pasos a seguir para ejecutar estos algoritmos desde IS Bench.
%				
%				
%				\begin{enumerate}
%					\item Crear un benchnark (o experimento) que incluya los algoritmos a ejecutar.
%					
%					\item Seleccionar el benchmark creado 
%					
%					\item Ejecutar
%					
%					\item Consultar los resultados
%				\end{enumerate}
